...
import HomeBgImg from '../public/Homepage.png';
...
function Home() {
  ...
  backgroundRepeat: 'no-repeat',
      ...
      <div>
        {/* Heading */}
        <h1 className="display-3 fw-bold mb-4 px-2 tracking-in-expand"
        style={{color: '#1bd8e2ff'}} >
          Welcome to Free Ready To Pass Exam <br />Digital Learning System
        </h1>
        <p className="lead fw-bold mb-5 tracking-in-expand" style={{fontSize: '1.5rem', color: '#000000de'}}>
...
{/*  */}
        ...
        <div className="d-flex gap-3 justify-content-center flex-wrap">
          ...
          <Link to='/about'className="btn btn-outline-dark btn-lg px-4 fw-bold">
            About Us
          </Link>
        </div>
      </div>
