...
import { getMatricResourcesAPI } from "../services/api";

function CoursesMatric() {

  const [resources, setResource] = useState([]);

  useEffect(()=>{
    getMatricResourcesAPI()
  ...
  return (
    <div className="bg-light min-vh-100 d-flex flex-column">
      ...
      <header className="bg-success text-white text-center py-5 shadow">
        <h1 className="fw-bold display-5">Matrci Resource</h1>
        <p className="lead">
